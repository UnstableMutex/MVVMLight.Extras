...
namespace MVVMLight.Extras.Commands
  {
      ...
      /// method is 'true'.
      /// </summary>
      public class AskSaveCommand : ICommand
      {
          #region Constructors
          ...
          public AskSaveCommand(Action<string> execute, string ext)
          ...
          ///  <param name="ext">extention with no dot</param>
          public AskSaveCommand(Action<string> execute, Func<bool> canExecute, string ext)
          {
              if (execute == null)
